...
4. **Variable Validation and Suppression:**
   ...
   - **Suppression:**
     - Mark variables as `sensitive=true` to prevent their output unless marked sensitive in the output block as well.
...
1. **Terraform Cloud Workspaces:**
   ...
   ![Terraform Cloud Workspaces](workspace_image.png)
